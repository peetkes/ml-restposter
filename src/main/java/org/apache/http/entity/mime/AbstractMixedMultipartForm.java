...
public abstract class AbstractMixedMultipartForm {
     ...
     */
    public AbstractMixedMultipartForm(final String subType, final Charset charset, final String boundary) {
        super();
    ...
    public AbstractMixedMultipartForm(final String subType, final String boundary) {
    ...
    public abstract List<MixedBodyPart> getBodyParts();
    ...
    void doWriteTo(
        ...
        for (final MixedBodyPart part: getBodyParts()) {
